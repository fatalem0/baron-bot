...
from baron.commands.create_event_cmd import set_date, set_place, set_location, set_attendees, set_min_attendees, \
        ...
        nearby_change_handlers() + [
            ...
            ConversationHandler(
                ...
                states={
                    ...
                    ATTENDEES: [
                        MessageHandler((filters.TEXT | filters.LOCATION), set_attendees)],
